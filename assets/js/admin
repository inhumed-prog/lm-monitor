jQuery(function($) {
    ...
    function showToast(message, type = 'info') {
        const $toast = $('<div class="lm-monitor-toast lm-monitor-toast-' + type + '">' + escapeHtml(message) + '</div>');
        $('body').append($toast);
     ...
     * Form validation
     */
    $('#lm-monitor-add-form').on('submit', function(e) {
        const $urlInput = $('#lm_monitor_url');
        const $emailInput = $('#lm_monitor_email');
     ...
     */
    $('#lm_monitor_url').on('blur', function() {
        const $input = $(this);
     ...
     */
    $(document).on('click', '.lm-monitor-check', function(e) {
        e.preventDefault();
     ...
     */
    $(document).on('click', '.lm-monitor-delete', function(e) {
        e.preventDefault();
     ...
     */
    $('#lm-monitor-add-form').on('submit', function() {
        const $submitBtn = $(this).find('button[type="submit"]');
        $submitBtn.prop('disabled', true).addClass('loading');
    });

    /**
     * Debug mode - log AJAX errors to console
     */
    if (LMMonitor.debug) {
